...
public class SamsungTV implements TV{
    ...
    String Samsung_tv_name = "Samsung Odyssey 4K 120hz TV"; //tv 이름
    ...
    public boolean tv_onandoff(boolean a) {
        if(a==false){
            System.out.println("Samsung code.Tv is On");
            a = true;
            return a;
        }
        else if(a=true) {
            System.out.println("Samsung code.Tv is Off");
            a = false;
            return a;
        }
        return a;
    ...
    public void Streaming() {
        System.out.println("Samsung TV Original Service!");
        System.out.println("Netflix에 접속 중..");
